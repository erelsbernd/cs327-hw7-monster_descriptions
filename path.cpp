...
void dijkstra(dungeon_t *d)
{
  ...
  d->pc_distance[character_get_y((character*)d->thepc)][character_get_x((character*)d->thepc)] = 0;
...
void dijkstra_tunnel(dungeon_t *d)
{
  ...
  d->pc_tunnel[character_get_y((character*)d->thepc)][character_get_x((character*)d->thepc)] = 0;
